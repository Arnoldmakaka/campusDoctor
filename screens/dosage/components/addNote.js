      ...
      <ScrollView style={{flex: 1}}>
        <KeyboardAvoidingView style={{flex: 1, marginHorizontal: 10,}} behavior="padding" enabled>
          <View style={{flex: 1}}>
            ...
            <TextInput onChangeText={props.onInputnumber} placeholder="Number of tablets/Injections" style={{textAlign: 'left', height: 40, color: '#00528e', borderBottomColor: '#00528e', borderBottomWidth: 2, marginVertical: 7}}/>
            ...
            <DatePicker
              ...
              onDateChange={(date) => {props.onInputdate}}
            />
          </View>
